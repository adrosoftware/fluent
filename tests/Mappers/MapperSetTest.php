...
class MapperSetTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function test_it_should_fail_when_asked_for_an_unmapped_class()
    {
        $this->setExpectedException(
            ...
            'Class [baz] does not have a mapping configuration. Make sure you create a Mapping class that extends either AdroSoftware\Fluent\EntityMapping, AdroSoftware\Fluent\EmbeddableMapping or AdroSoftware\Fluent\MappedSuperClassMapping. If you are using inheritance mapping, remember to create mappings for every child of the inheritance tree.'
        );
