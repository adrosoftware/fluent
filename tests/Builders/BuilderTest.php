...
use AdroSoftware\Fluent\Builders\Embedded;
use AdroSoftware\Fluent\Builders\EntityListeners;
...
use AdroSoftware\Fluent\Builders\LifecycleEvents;
use AdroSoftware\Fluent\Builders\Primary;
use AdroSoftware\Fluent\Builders\Table;
...
class BuilderTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function test_can_set_entity_settings()
    {
        $entity = $this->fluent->entity(function ($entity) {
            $this->assertInstanceOf(\AdroSoftware\Fluent\Builders\Entity::class, $entity);
        });
