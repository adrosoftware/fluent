...
use AdroSoftware\Fluent\EntityMapping;
use AdroSoftware\Fluent\Fluent;
use AdroSoftware\Fluent\FluentDriver;
...
class FluentDriverTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->setExpectedException(\InvalidArgumentException::class, 'Mapping class [Tests\Stubs\Entities\StubEntity] should implement AdroSoftware\Fluent\Mapping');
    ...
    public function test_it_should_fail_when_asked_for_metadata_that_was_not_added_to_it()
    {
        ...
        $this->setExpectedException(
            ...
            'Class [Tests\FakeEntity] does not have a mapping configuration. Make sure you create a Mapping class that extends either AdroSoftware\Fluent\EntityMapping, AdroSoftware\Fluent\EmbeddableMapping or AdroSoftware\Fluent\MappedSuperClassMapping. If you are using inheritance mapping, remember to create mappings for every child of the inheritance tree.'
        );
